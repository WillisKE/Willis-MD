...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "254702365210,254786273945";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "©ωιℓℓιѕ²⁵⁴м∂" , // ```『 ρσωєяє∂ ву ωιℓℓιѕ кє 』```", //*『ωιℓℓιѕ кє』*\n youtube.com/@WillisKE0"),
 
  author : process.env.PACK_AUTHER|| "ωιℓℓιѕ",
  packname: process.env.PACK_NAME || "м∂",
